...
All members in our group are responsible for collecting data since we hope to collect data on topics that both of us are interested in. Since the legal use of gun is a long existing and controversial problems in the United States, we decide to search for data related to this topic and finally reach the our data source website that have comprehensive data containing 